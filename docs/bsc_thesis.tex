...
\newcommand{\vikcim}{Reduced Order Modeling\\of Fluid Dynamics} % Cím
...
\include{content/mathematical-foundations}
\include{content/physical-simulations}
\include{content/fluid-simulation}
\include{content/controlling-laplacian-eigenfluids}
\include{content/discussion-and-future-work}
