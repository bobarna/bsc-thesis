...
\todo[inline]{Is this right? (I know that the Fourier transform is a huge topic
with a deep breadth, and I don't want to upset any mathematicians nor engineers.
:) )}
