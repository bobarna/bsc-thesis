...
\todo[inline]{Eigenvalues, eigenfunctions.}
\todo[inline]{Introduce SVD and Fourier transform as examples of extracting
lower-dimensional structure from high-dimensional data. Also mention PCA... and
refer to literature on them.}
