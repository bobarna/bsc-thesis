...
\todo[inline]{This is a new section, giving an introduction, and laying out the
motivation behind reduced order modeling, and leads up to introducing the
Eigenfluids algorithm in the next chapter.}
